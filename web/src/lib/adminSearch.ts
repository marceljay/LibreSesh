...
export const ADMIN_SETTINGS: AdminSetting[] = [
  ...
  },
  {
    ...
    label: 'Nostr',
    tab: 'publish',
    keywords: 'nostr relay npub nsec key publish calendar follow decentralised',
    anchor: 'nostr',
  },
  {
    id: 'nostr-relays',
    label: 'Relays',
    tab: 'publish',
    keywords: 'nostr relay wss server list',
    anchor: 'nostr',
  },
  {
    id: 'nostr-triggers',
    label: 'What it posts',
    tab: 'publish',
    keywords: 'nostr note trigger pitch placed up next digest added moved',
    anchor: 'nostr',
  },
  {
    id: 'nostr-key',
    label: 'Signing key',
    tab: 'publish',
    keywords: 'nostr nsec export import key backup identity',
    anchor: 'nostr',
  },
  {
    id: 'nostr-retract',
    label: 'Retract everything',
    tab: 'publish',
    keywords: 'nostr delete remove retract unpublish',
    anchor: 'nostr',
  },
  {
    id: 'archive',
