...
nothing local is unsaved. Suite at **1858**, lint clean, build clean. Most
recent cut: **0.7.4**.
...
- **Telegram announcements** [LIB-207, LIB-208, LIB-209, LIB-210] (2026-09-15).
  ...
  group from Manage → Settings → Telegram and is told what is coming up, once
  ...
  Manage Event section, 33 tests. **Never run against a real bot** — nothing in
